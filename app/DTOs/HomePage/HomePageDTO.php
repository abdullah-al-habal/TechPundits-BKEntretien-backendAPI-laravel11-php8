...
use App\Http\Requests\API\V1\HomePage\CreateHomePageRequest;
...
class HomePageDTO
{
    ...
    // public static function fromRequest(CreateHomePageRequest|UpdateHomePageRequest $request): self
    // {
    ...
    //         id: $request instanceof UpdateHomePageRequest ? $validated['id'] : null
    //     );
    // }
